...
def show_home():
    ...
    with col2:
        ...
        <div style="background:#f8f9ff; border-radius:12px; padding:1.5rem;
            ...
            <table style="width:100%; font-size:0.95rem; border-collapse:collapse;">
                <tr style="padding:4px 0;">
                    <td style="padding:4px 0;"><b>Nama</b></td>
                    <td>: Aliffia Humairah</td>
                </tr>
                <tr>
                    <td style="padding:4px 0;"><b>NIM</b></td>
                    <td>: 2311531004</td>
                </tr>
                <tr>
                    <td style="padding:4px 0;"><b>Prodi</b></td>
                    <td>: Informatika</td>
                </tr>
                <tr>
                    <td style="padding:4px 0;"><b>Matkul</b></td>
                    <td>: DIF60202 Image Processing</td>
                </tr>
                <tr>
                    <td style="padding:4px 0;"><b>Dosen</b></td>
                    <td>: Derisma, MT</td>
                </tr>
                <tr>
                    <td style="padding:4px 0;"><b>Semester</b></td>
        ...
        techs = ["Python 3.10", "TensorFlow 2.x", "MobileNetV2",
