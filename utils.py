...
CATEGORY_MAP = {
    'battery':     ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik yang dapat didaur ulang secara khusus.'),
    'biological':  ('Organik',    '🌱', '#4CAF50',
                    'Sampah organik yang dapat terurai secara alami.'),
    'brown-glass': ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik yang dapat didaur ulang.'),
    'cardboard':   ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik yang dapat didaur ulang.'),
    'clothes':     ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik, donasikan jika masih layak.'),
    'green-glass': ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik yang dapat didaur ulang.'),
    'metal':       ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik bernilai ekonomis tinggi.'),
    'paper':       ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik yang dapat didaur ulang.'),
    'plastic':     ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik, kurangi penggunaannya.'),
    'shoes':       ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik, donasikan jika masih layak.'),
    'trash':       ('Residu',     '🗑️', '#F44336',
                    'Sampah residu, tidak dapat didaur ulang.'),
    'white-glass': ('Anorganik',  '♻️', '#2196F3',
                    'Sampah anorganik yang dapat didaur ulang.'),
}
